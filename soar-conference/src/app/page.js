  ...
  return (
    ...
    <div className="relative w-full bg-[image:url(/background.png)] bg-repeat bg-center" >
      ...
      <div className="w-full h-full mx-auto right-0 left-0 absolute bg-black opacity-65 top-0 bottom-0 z-10"></div>
        ...
        <h1 className="mx-auto text-center z-20 mt--4 grad bg-clip-text text-transparent w-fit place-self-center text-9xl lg:text-10xl lg:ps-10 bg-size-200 animate-moving_gradient ">SOARCADE</h1>
        </div>
      </header>
